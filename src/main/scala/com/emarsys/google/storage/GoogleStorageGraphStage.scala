...
object GoogleStorageGraphStage {
  ...
  def apply(storageChannel: ReadChannel, chunkKByteSize: Int = 64): GoogleStorageGraphStage =
    new GoogleStorageGraphStage(storageChannel, chunkKByteSize)

}

class GoogleStorageGraphStage(storageChannel: ReadChannel, chunkKByteSize: Int = 64)
